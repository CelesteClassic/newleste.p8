...
arrow_platform={
  ...
  draw=function(this)
    ...
    rectfill(x,y,x+this.w*8-1,y+this.h*8-1,1)
    rect(x+1,y+2,x+this.w*8-2,y+this.h*8-2,13)
    line(x+3,y+2,x+this.w*8-4,y+2,1)
    spr(this.break_timer>8 and 72 or 71,x+this.w*4-4,y+this.h*4-4)
    if this.h==1 and this.break_timer>8 then 
      rect(x+this.w*4-3,y+this.h*4-3,x+this.w*4+2,y+this.h*4+2,1)
    end
    line(x+1,y,x+this.w*8-2,y,13)
    if not this.check(player,0,-1) and not this.is_solid(0,-1) then
      line(x+2,y-1,x+this.w*8-3,y-1,13)
    end
    pal()
  end
...

...

