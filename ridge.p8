...
bouncy_cloud = {
    ...
    --idle position
      ...
      if this.y-this.start > 7 and #this.particles==0 then
	...
	draw=function(this)
      ...
      for p in all(this.particles) do
        ...
        p.t-=0.25
        p.y+=0.3
        if p.t <=0 then del(this.particles, p) end
      end
      local w = (this.y-this.start)/2
      sspr(0, 32, 16, 8, this.x-w/2,this.y-1,16+w,8)
			pal()
		end
	end
}

function make_cloud_particles(this)
  this.particles={}
  for i=0,rnd(5)+5 do 
    add(this.particles, {
      x=this.x+rnd(14)+1,
...
bg_flag={
  init=function(this) 
    ...
    this.h=this.spr==78 and 2 or 1
    this.w=this.spr==78 and 1 or 2
  end, 
  update=function(this)
...

__label__
...

