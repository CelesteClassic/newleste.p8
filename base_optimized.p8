...
function init_object(_type,sx,sy,tile)
  local tp = _g[_type] or lifeup

  --generate and check berry id
  local id=sx..","..sy..","..lvl_id
  if tp.check_fruit and got_fruit[id] then
    return
  end
  --local _g=_g
  local _ENV={}
  type, collideable, sprite, flip, x, y, hitbox, spd, rem, fruit_id, outline, draw_seed=
  tp, true, tile, _g.vector(), sx, sy, _g.rectangle(0,0,8,8), _g.vector(0,0), _g.vector(0,0), id, true, _g.rnd()
  ...
  function check(type,ox,oy)
    for other in all(objects[type]) do
      if other.type==_g[type] and other~=_ENV and objcollide(other,ox,oy) then
        return other
      end
    end
  end
  ...
  if (not objects[_type]) objects[_type] = {}
  add(objects[_type],_ENV)
  add(objects,_ENV);
...

...

