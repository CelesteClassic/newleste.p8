...
spinner={
  init=function(_ENV)
    ...
    for i=1,2 do 
      local hit=check(spinner,-1,0) or check(spinner,0,-1)
      if hit then 
        concat(list, hit.list)
        destroy_object(hit)
      end
    end 
  end,
  ...
  update=function(_ENV)
    ...
    if pl then 
      ...
      for s in all(list) do 
        --printh(s.x..", "..s.y)
        hitbox=rectangle(s.x,s.y,8,8)
        if pl.objcollide(_ENV,0,0) then 
          --assert(false)
          kill_player(pl)
          break 
        end 
  ...
  draw=function(_ENV)
    foreach(list,function (spinner)
        rectfill(spinner.x,spinner.y,spinner.x+8,spinner.y+8,8)
    end)
  end 
}
psfx=function(num)
...

...

