...
cassette_time=60 --full cassette cycle time in frames
...
cassette_block={
  init=function(this)
  		this.col=this.spr==80 and 1 or 2
    
    this.timer=this.col*cassette_time/2
				this.outline=false
  ...
  local hit=this.player_here()
  this.timer+=1
  local c_time=this.timer%cassette_time

  this.state=c_time<cassette_time/2
  this.solid_obj=not(hit or this.state)
  this.blink=max(0,(cassette_time/2+2)-(c_time))
  this.drop=((c_time<cassette_time-3) and 0 or 1)-this.blink
  end,
  
  	draw=function(this)

  		if this.solid_obj then
  			local top=this.y+this.drop
  			local bottom=this.y+this.hitbox.h
  			local left=this.x-this.blink
  			local right=this.x+this.hitbox.w-1+this.blink
  			rectfill(left,top-this.blink,right+this.blink,bottom+1,this.col)
  			rectfill(left,top-this.blink,right+this.blink,bottom-1,this.spr==80 and 12 or 14)
  		 rect(this.x+1,top+1,right-1,bottom-2,this.col)
  		else
    		...
    		for y=0,this.hitbox.h/8-1 do
    			spr(this.spr,this.x+x*8,2+this.y+y*8)
  				end
  			end
  			rect(this.x,this.y+2,this.x+this.hitbox.w-1,this.y+this.hitbox.h+1,1)
  		 palt(0,true)
  		end
  end
}
...

...

__sfx__
