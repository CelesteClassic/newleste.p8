...
fuzz={
  ...
  init=function(_ENV)
    ...
    if sprite%2==0 then
      while axis=="x" and r<lvl_pw and not fget(tile_at(r\8,y\8),0) and not fget(tile_at(r\8,y\8),6) or
            axis=="y" and r<lvl_ph and not fget(tile_at(x\8,r\8),0) and not fget(tile_at(x\8,r\8),6) do
        r+=8
      end
      r-=8
      dir=1
    else
      while axis=="x" and l>=0 and not fget(tile_at(l\8,y\8),0) and not fget(tile_at(l\8,y\8),6) or
            axis=="y" and l>=0 and not fget(tile_at(x\8,l\8),0) and not fget(tile_at(x\8,l\8),6) do
          l-=8
      end
      l+=8
      dir=-1
...

...

