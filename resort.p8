...
fuzz={
  ...
  init=function(_ENV)
    ...
    -- derive axis from sprite
    local a={"y","x",nil,"r+","r-"}   --axis=(sprite==62 and "x") or (sprite==61 and "y") or (sprite==64 and "r+") or (sprite==65 and "r-")
    axis=a[sprite-60]
    sliding = false
    ...
    if (axis=="x" or axis=="y") then -- sliding fuzzies only
      ...
      local b,c=x/8,y/8
      -- reverse starting direction if needed
      if axis=="x" and (x+8>=lvl_pw or not fget(tile_at(b+1,c),6)) or axis=="y" and (y+8>=lvl_ph or not fget(tile_at(b,c+1),6)) then
          dir = -1
      end
      -- get endpoints
      ...
      -- if this fuzzy is sliding along/inside of a wall
      if (axis=="x" and (mget(r\8,c) == 70 or mget(l\8,c) == 70)) then
        y += fget(tile_at(b,c+1),6) and 4 or -4
        sliding = true
      end
      if (axis=="y" and (mget(b,r\8) == 70 or mget(b,l\8) == 70)) then
        x += fget(tile_at(b+1,c),6) and 4 or -4
        sliding = true
      end

      -- keep endpoints halfway in wall
      r-=2
      l+=2
    ...
    if (#fuzzy_drawer.fuzzies!=0) then
      ...
      for f in all(fuzzy_drawer.fuzzies) do
        ...
        if f.sprite ~= 63 then -- moving fuzzies
          if (f.axis=="r+" or f.axis=="r-") f.t+=0.02
          -- flip
          if f.t==27 then
          ...
          -- eyes
          if (f.axis=="x" or f.axis == "y") f.eye_offset = mid(-5,appr(f.eye_offset,(f.t<20 and f.dir or -f.dir)*4*f.scale,1),5)

          eyes[#eyes+1] = {
            f.x + 3.5 + (
              f.axis=="x" and f.eye_offset
              or f.axis=="r+" and cos(-f.t-0.125)*4
              or f.axis=="r-" and cos(f.t-0.125)*4
              or -3
            ),
            f.y + 4 + (
              f.axis=="y" and f.eye_offset*.7
              or f.axis=="r+" and sin(-f.t-0.125)*4
              or f.axis=="r-" and sin(f.t-0.125)*4
              or -4
            )
          }
...
mapdata={
  [3] = "",
  [5] = ""
}
--@end
...

...
__gff__

...

...

