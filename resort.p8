...
fuzz={
  ...
  init=function(this)
    ...
    if axis~="theta" then
      ...
      local r=this[axis]
      -- grab max positions
      while axis=="x" and r<lvl_pw and not fget(tile_at(r\8,this.y\8),0) and not fget(tile_at(r\8,this.y\8),6) or
            axis=="y" and r<lvl_ph and not fget(tile_at(this.x\8,r\8),0) and not fget(tile_at(this.x\8,r\8),6) do
        r+=8
      end 
      -- set max positions 
      this[axis]-=4
  ...
  update=function(this)
    ...
    if axis=="x" or axis=="y" then
      if this[axis]>=this.r then
        ...
        this.spd[axis]=appr(this.spd[axis],0,0.1) 
      elseif this[axis]<=this.l then
        this.f_dir=1 --this.spd.x,this.spd.y=0,0
        this.spd[axis]=appr(this.spd[axis],0,0.1) 
      end
      this.spd[axis]=appr(this.spd[axis],3*this.f_dir,0.4)
    end
    local hit=this.player_here()
    if hit then 
      kill_player(hit)
...
still_fuzz={
  ...
  init=function(this)
    ...
    this.collides=true
    --this.flip.x,this.flip.y=false,false
    this.flip.y = (this.spr==45 and this.is_solid(0,-1)) or (this.spr==46 and this.is_solid(0,1))
    this.flip.x = ((this.spr==47 and this.is_solid(-1,0)) or (this.spr==61 and this.is_solid(1,0)) and true) or false
    --fix this flipping and also add random flipping for center still fuzzies.
...

...

