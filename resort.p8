    ...
    if (#fuzzy_drawer.fuzzies!=0) then
      ...
      for f in all(fuzzy_drawer.fuzzies) do
        if f.sprite ~= 63 then -- moving fuzzies
          ...
          -- eyes
          f.eye_offset = appr(f.eye_offset,(f.t<20 and f.dir or -f.dir)*4*f.scale,1)
          eyes[#eyes+1]={f.axis=="x" and f.x+4+f.eye_offset or f.x+1,f.axis=="y" and f.y+4+f.eye_offset*.7 or f.y}
          eyes[#eyes+1]={f.axis=="x" and f.x+4+f.eye_offset or f.x+6,f.axis=="y" and f.y+4+f.eye_offset*.7 or f.y+5}
...
__gff__

...

