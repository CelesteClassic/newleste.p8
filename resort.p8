    ...
    if (#fuzzy_drawer.fuzzies!=0) then
      ...
      for f in all(fuzzy_drawer.fuzzies) do
        ...
        if f.sprite ~= 63 then -- moving fuzzies
          ...
          eyes[#eyes+1]={f.x + 3.5 + (f.axis=="x" and f.eye_offset or f.axis=="r+" and cos(-f.t-3.141592)*4 or f.axis=="r-" and cos(f.t-3.141592)*4 or -3), f.y + 4 + (f.axis=="y" and f.eye_offset*.7 or f.axis=="r+" and sin(-f.t-3.141592)*4 or f.axis=="r-" and sin(f.t-3.141592)*4 or -4)}
          eyes[#eyes+1]={f.x + 3.5 + (f.axis=="x" and f.eye_offset or f.axis=="r+" and cos(-f.t+3.141592)*4 or f.axis=="r-" and cos(f.t+3.141592)*4 or 2), f.y + 4 + (f.axis=="y" and f.eye_offset*.7 or f.axis=="r+" and sin(-f.t+3.141592)*4 or f.axis=="r-" and sin(f.t+3.141592)*4 or 1)}
        end
...
mapdata={
  ...
  [5] = ""
}
--@end
...

