...
levels={
  ...
  "11.0625,-2.5625,1,2,0b0010,1,more badelines could be added to make it feel more intense. could perhaps be tweaked a bit?",
...
local __init = _init function _init() __init() load_level(16) music(-1) end
--@end
