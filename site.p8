...
switch_block={
  ...
  update=function(this)
    ...
    if this.active then
      this.spd=vector(sign(this.target.x-this.x),sign(this.target.y-this.y))
    end 
  end, 
  draw=function(this)
...

...

