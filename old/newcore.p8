...
player={
  ...
  update=function(this)
    ...
    if on_ground then
      this.grace=6
      if not core and this.djump<max_djump then
        psfx(7)
        this.djump=max_djump
      end
...
wall_booster={
	init=function(this)
		this.offset=0
		this.left=this.spr==65
	end,
	draw=function(this)
		local side=this.left and 4 or 0
		if hot then
		...
		if mget(this.x/8,this.y/8-1)==0 then
			spr(65,this.x-side,this.y)
		elseif mget(this.x/8,this.y/8+1)==0 then
			spr(65,this.x-side,this.y+4)
		end
		pal()
	end,
}
...
-- <core> --
	if hot then
		local _pal={128,129,130,131,132,133,134,135,136,137,138,139,140,141,142,143}
...

...
__gff__

...

__sfx__
