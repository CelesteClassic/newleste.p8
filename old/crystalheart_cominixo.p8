...
crystal_heart = {
    ...
    update=function(this)
        ...
        this.offset+=0.01
        this.y=this.start_y+sin(this.offset)*2
        this.x=this.start_x
        
        this.hitbox={x=-1,y=-1,w=18,h=18}
        local hit = this.collide(player,0,0)
        
        -- heart knockback stuff (bad)
        this.x += this.x_speed
        if this.x_speed > 0 then
            this.x_speed-=1
        elseif this.x_speed < 0 then
            this.x_speed+=1
        end
        ...
        elseif hit then
            if this.y+8 > hit.y then
                hit.spd.y=-2
                this.y_speed = 2
            elseif this.y+8 < hit.y then
                hit.spd.y=2
                this.y_speed = -2
            end
            
            if this.x+8 > hit.x then
                hit.spd.x=-2
                this.x_speed = 2
            elseif this.x+8 < hit.x then
                hit.spd.x=2
                this.x_speed = -2
            end
...

...

