	...
	update=function(this) 
		if this.spr==98 then
			...
			if hit~=nil then
				...
				this.x=hit.x
				this.y=hit.y
				this.spd.x=hit.spd.x/2
				this.spd.y=hit.spd.y/2
				shake=8
				destroy_object(hit)
			end
		elseif this.timer>0 then
		...
		if this.spawntimer > 0 then
			this.spawntimer-=1
			this.spd.x=appr(this.spd.x, 0, 0.4)
			this.spd.y=appr(this.spd.y, 0, 0.4)
			if this.spawntimer==0 then
				init_object(smoke,this.x,this.y)
...
feather_player={
	init=function(this)
		...
		this.tail={}
		for i=0,5 do
			add(this.tail,{x=this.x,y=this.y,size=max(1,min(2,4-i))})
		end
		this.particles={}
	end,
	update=function (this)
		...
		if inputx ~= 0 or inputy ~= 0 then
			this.spd.x *= 1.5 + clamp((this.lifetime-80)/10, 0, 10)
			this.spd.y *= 1.5 + clamp((this.lifetime-80)/10, 0, 10)
		end
...

...

...
a49499999999494a0000000000000000000000000000000040000000400000004000000000010000000000000000000000000000000000000000000000000010
...
__gff__

...

...

...

