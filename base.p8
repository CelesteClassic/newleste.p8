...
heart_col={1,12} --color values for crystal heart
...
crystal_heart = {
 ...
 update=function(_ENV)       
  local hit = player_here()
   if not hide then
    offset+=0.01
    y=start_y+sin(offset)*2
    x=start_x
    -- heart knockback
    x+=x_speed
    y+=y_speed
    x_speed+=x_speed>0 and -1 or x_speed<0 and 1 or 0
    y_speed+=y_speed>0 and -1 or y_speed<0 and 1 or 0    
    ...
    elseif hit then
     if y+8>hit.y then
      hit.spd.y,y_speed=-2,-2
     elseif y+8<hit.y then
      hit.spd.y,y_speed=2,-2
     end
     if x+8>hit.x then
      hit.spd.x,x_speed=-2,2
     elseif x+8<hit.x then
      hit.spd.x,x_speed=2,-2
     end
     end
    end  
   if hide then
    ...
    if slow_player then
     soff+=.1
     p.spd=vector(p.spd.x/soff,p.spd.y/soff)
    end
    if soff>1.4 then
     if not mkprt then for i=1,16 do
      add(particles,{x=x+rnd"16",y=y+rnd"16",dx=rnd"6"-3,dy=rnd"6"-3})
     end for dx=0,15,8 do for dy=0,15,8 do init_smoke(dx,dy) end end end
     mkprt=true
     foreach(particles,function(t)
      t.x+=t.dx
      t.y+=t.dy
      t.dx+=t.x>p.x and -0.1 or 0.1
      t.dy+=t.y>p.y and -0.1 or 0.1
      if (t.x>p.x-4 and
      t.x<p.x+p.hitbox.w+4 and 
      t.y>p.y-4 and
      t.y<p.y+p.hitbox.h+4) or soff>10 then
       del(particles,t)
      end
     end)
    end
    ...
    draw=function(_ENV)
      pal(1,_g.heart_col[1])
      pal(12,_g.heart_col[2])
     if not(hide and soff>1.4) then
      sspr(104,16,8,16,x,y)
      sspr(104,16,8,16,x+8,y,8,16,true)
     end
     pal()
     foreach(particles,function(p) 
      for i=0,2 do
      circfill(p.x-p.dx*i,p.y-p.dy*i,2,7)
      end
     end) 
    end
  }
...

__label__
...

