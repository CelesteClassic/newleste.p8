...
cassette_block={
  init=function(this)
    ...
    this.timer=this.spr==45 and 0 or 30
				this.outline=false
				
				while this.right()<lvl_pw-1 and tile_at(this.right()/8+1,this.y/8)==this.spr-16 do 
      this.hitbox.w+=8
    end 
    while this.bottom()<lvl_ph-1 and tile_at(this.x/8,this.bottom()/8+1)==this.spr-16 do 
      this.hitbox.h+=8
    end
  ...
  local hit=this.player_here()
  	this.timer+=1
  this.state=this.timer%60<30
  
  	if hit or this.state then
  	...
  	draw=function(this)
  		palt(0,false) --make black opaque when rendering cassette blocks in the off state
  		for x=0,this.hitbox.w/8-1 do
    	for y=0,this.hitbox.h/8-1 do
    		spr(this.solid_obj==true and this.spr or this.spr-16,this.x+x*8,this.y+y*8)
  			end
  		end
  		palt(0,true)
  end
...

...

__sfx__
