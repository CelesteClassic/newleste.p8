          ...
          -- <zip_mover>
            ...
            if hit and hit.state==1 then 
              ...
              elseif hit.delay==0 and d<=7 then 
                this.spd=vector(hit.dir.x*3,min(3*hit.dir.y,-2))
              else
                this.spd.y=-2
                if abs(hit.spd.x)>=3 then 
                  this.spd.x=hit.dir.x*2.5
                end 
              end 
...

