        ...
        if this.grace>0 then
          ...
          -- <zip_mover>
            ...
            if hit and hit.state==1 then 
              ...
              if hit.delay>=12 or d<=2 and d!=0 then 
                this.spd=vector(hit.dir.x*3.5,min(3*hit.dir.y,-2))
              elseif hit.delay==0 and d<=5 then 
                this.spd=vector(hit.dir.x*2.5,min(3*hit.dir.y,-2))
              else 
                this.spd.y=-2
              end 
...

