...
fall_floor={
  ...
  update=function(_ENV)
    ...
    if state==0 then
      for i=0,2 do
        if check(_g.global_player,i-1,-(i%2)) then
          psfx(13)
          state,delay=1,15
          init_smoke()
          break
...
function init_object(_type,sx,sy,tile)
  ...
  function check(type,ox,oy)
    if type == _g.global_player then
      if _g.global_player and objcollide(_g.global_player,ox,oy) then return _g.global_player end
      return
    end
  ...
  function player_here()
    return check(_g.global_player,0,0)
  end
  ...
  function move(ox,oy,start)
    for axis in all{"x","y"} do
      ...
      local riding,movamt=not player_here() and check(_g.global_player,0,upmoving and amt or -1)--,nil
      if collides then
...
function _update()
  ...
  -- initial performance test [15/30, 6.3, 6.3]
  -- intermediary results     [15/30, 6.2, 6.1] with camera loop removed
  -- intermediary results     [15/30, 6.2, 6.1] with camera loop removed and pairs loop (changing back for now)
  -- intermediary results     []
  -- target performance test  [30/30, etc, etc]
  ...
  -- update each object
  -- for _,_ENV in pairs(objects) do
  --   move(spd.x,spd.y,type==player and 0 or 1);
  --   (type.update or time)(_ENV)
  --   draw_seed=rnd()
  -- end
...
__map__

...

__sfx__
