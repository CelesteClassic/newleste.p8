...
dash_switch={
  ...
  update=function(this)
    if not this.active then 
      local hit=this.check(player,0,-this.diry) or this.check(theo_crystal,0,-this.diry)
      if hit then 
        --<theo_crystal> --
        if hit.type==theo_crystal or (hit.dash_effect_time>3 and sign(hit.dash_target_y)==this.diry) then 
          if hit.type==theo_crystal then 
            -- TODO: make theo not bounce off, after fixing solids system for theo
          end 
          --</theo_crystal> --
          this.spd.y=3*this.diry
          this.active=true
          local closest
      ...
      this.spd.y=mid(this.ogy+6*this.diry-this.y,3,-3)
    end 
    this.t=(this.t+1)%45
  end,
  draw=function(this)
...

...

...

