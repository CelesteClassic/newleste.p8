...
dash_switch={
  ...
  init=function(this)
    this.solid_obj=true
    this.hitbox=rectangle(0,3,10,5)
    this.ogy=this.y
    this.t=0
  end, 
  update=function(this)
    if not this.active then 
      ...
      if hit then 
        if hit.dash_effect_time>3 then 
          this.spd.y=3
          this.active=true
          local closest
          for o in all(objects) do
            if o.type==switch_door and o.delay==0 and not o.active and 
            (not closest or (this.x-closest.x)^2+(this.y-closest.y)^2>(this.x-o.x)^2+(this.y-o.y)^2) then 
              closest=o 
            end 
          end 
          (closest or {}).delay=10
        else 
          this.spd.y=sign(this.ogy+2-this.y)
        end 
      else 
        this.spd.y=sign(this.ogy-this.y)
      end 
    else 
      this.spd.y=min(this.ogy+6-this.y,3)
    end 
    this.t=(this.t+1)%45
  end,
  draw=function(this)
...
switch_door={
  ...
  update=function(this)
    ...
    if this.active then 
      this.spd.y=max(appr(this.spd.y,-3,1),this.ogy-22-this.y)
    end 
  end,
  draw=function(this)
  
    local x,oy,y=this.x,this.ogy,this.y
    if this.delay<5 and this.delay>2 then 
      x+=rnd(2)-1
    end 
...
seeker={
  init=function(this)
    ...
    this.state=0
    this.delay=10
    this.wdir=vector(0,0)
    this.wt=0
    this.wv=0
    this.collides=true
  end,
  update=function(this) 
    if this.state==0 then --wander
      -- add check to switch to charge state here
      this.hitbox=rectangle(1,1,17,17) --bigger hitbox for wander, remember to change back for charge
      if this.delay>0 then 
        this.delay-=1
      else 
        this.spd=vector(this.wv*this.wdir.x,this.wv*this.wdir.y)
        if this.spd.x!=0 then this.flipx=this.spd.x>0 end 
        if this.wt>0 and not this.is_solid(sign(this.wdir.x),sign(this.wdir.y)) then 
          this.wt-=1
        else 
          --local pwdirx,pwdir=this.wdir.x,this.wdir.y 
          -- while this.wdir.x==pwdirx or this.wdir.y==pwdiry and not this.is_solid(this.wdir.x,this.wdir.y) do 
          --   this.wdir.x=flr(rnd(3)-1)
          --   this.wdir.y=(1-abs(this.wdir.x))*(sign(rnd()-0.5))
          -- end 
          repeat
            local ang=flr(rnd(8))/8
            this.wdir=vector(cos(ang),sin(ang))
          until not this.is_solid(sign(this.wdir.x),sign(this.wdir.y))
          this.rem=vector(0,0)
          this.wv=rnd(1.5)+0.5
          this.wt=rnd(90)+20
          this.delay=rnd(10)
    ...
    elseif this.state==1 then --charge
      local hit=this.player_here()
  ...
  draw=function(this)
    ...
    -- for p in all(objects) do 
    --   if p.type==player then
    --     --line(this.x+9,this.y+9,p.x+4,p.y+4,4)
    --   end 
    -- end 

    -- for p in all(this.line) do 
    ...
    spr(83,this.x,this.y,2,2,this.flipx)
    pal()
  end
}
...

...
__map__

__sfx__
