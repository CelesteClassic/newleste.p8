...
spinner_h={
  ...
  init=function(this)
    ...
    local r=this.x 
    while r<lvl_pw and not fget(tile_at(r\8,this.y\8),0) do 
      r+=8
    end 
    this.x-=4
    this.l=this.x 
  ...
  update=function(this)
    if this.x>=this.r then
      this.dir=-1
    elseif this.x<=this.l then
      this.dir=1
    end 
    this.spd.x=appr(this.spd.x,2*this.dir,0.4)
    local hit=this.player_here()
    if hit then 
      kill_player(hit)
    end 
  ...
  draw=function(this)
    for i=0,3 do
      spr(abs(2*this.x-this.l-this.r)<8 and 113 or 112,this.x+(i%2)*8,this.y+i\2*8,1,1,i%2!=0,i>1)
    end
  end 
}
psfx=function(num)
...

...

