...
swap_block={
  init=function(_ENV)
    solid_obj=true
		start=x
		timer=-1
    hitbox=rectangle(0,0,16,24)
    edge=x+8
    while tile_at(edge\8,y\8)!=74 do
      edge+=8
    end
	end,
  update=function(_ENV)
    if timer>=0 then 
      spd.x=min(appr(spd.x,6,1),edge-x)
      timer+=1
      if timer==30 then
        timer=-1
      end
    else
      spd.x=max(appr(spd.x,-2,0.25),start-x)
    end
  end,
  draw=function(_ENV)
    if pal==_pal then --don't draw track outline
      for i=start,edge+hitbox.w-8,edge+hitbox.w-8-start do
        for j=y,y+hitbox.h-8,hitbox.h-8 do 
          spr(74,i,j,1,1,i!=start,j!=y)
        end
      end
      for i=start+8,edge+hitbox.w-16,8 do 
        spr(73,i,y)
        spr(73,i,y+hitbox.h-8,1,1,false,true)
      end
      for i=y+8,y+hitbox.h-16,8 do 
        spr(90,start,i)
        spr(90,edge+hitbox.w-8,i,1,1,true,false)
      end
    end
    for i=0,3 do 
      local cx,cy=i%2,i\2
...

...

